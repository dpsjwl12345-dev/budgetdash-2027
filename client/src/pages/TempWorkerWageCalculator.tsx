...
const JOB_RATES: JobRate[] = [
  { key: "admin", label: "생활임금 (행정/도서/농림/환경정비원 등)", dailyWage: 102000, note: "화성시 생활임금 우선 적용 - 기본값 (시급 12,750원 × 8h)" },
  { key: "counsel", label: "사례관리/상담/조사원 등", dailyWage: 102000, note: "해당 업무 전담 임금 적용 (시급 12,750원 × 8h)" },
