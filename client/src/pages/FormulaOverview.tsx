...
const FORMULA_ENTRIES: FormulaEntry[] = [
  {
    ...
    title: "기간제근로자등 보수",
    item: "기본급",
    condition: "일일단가(2027 생활임금 적용 직종 기준 일급 103,680원) × 근로일수",
  ...
  },
  {
    ...
    title: "기간제근로자등 보수",
    item: "주휴수당",
    condition: "일요일 및 근로자의 날 기준, 일일단가(생활임금 직종 일급 103,680원)",
  ...
  },
  {
    ...
    title: "기간제근로자등 보수",
    item: "연차수당",
    condition: "미사용 연차 기준, 일일단가(생활임금 직종 일급 103,680원)",
  ...
  },
  {
    ...
    condition: "월 평균 기준일수(주휴일 포함) 27일 적용 (예: 생활임금 직종 6개월 고용 = 일급 103,680원 × 162일 = 16,796,160원)",
  ...
  },
  {
    ...
    code: "203-02",
    title: "정원가산업무추진비",
    item: "적용 예시 - 본청 소속 현원 120명",
    condition: "본청: 100명까지 1인당 80,000원 / 101~300명 1인당 60,000원 (현원 구간별 누적 합산)",
  ...
  },
  {
    ...
    code: "203-02",
    title: "정원가산업무추진비",
    item: "적용 예시 - 사업소 소속 현원 150명",
    condition: "사업소: 100명까지 1인당 40,000원 / 101~400명 1인당 30,000원 (현원 구간별 누적 합산)",
  ...
  },
  {
    ...
    code: "203-04",
    title: "부서운영업무추진비",
    item: "적용 예시 - 30인 이하 (현원 18명)",
    condition: "부서 현원 5인 단위 구간별 월 기준액표 적용",
